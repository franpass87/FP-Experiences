<?php
/**
 * RTB Approved email template (without payment link - for instant booking mode).
 *
...
<div style="font-family: 'Helvetica Neue', Arial, sans-serif; color:#1f2933; line-height:1.6;">
    <h1 style="font-size:22px; margin:0 0 16px; color:#0b3d2e;">
        <?php echo esc_html($translate('rtb_approved.heading', [(string) ($experience['title'] ?? '')])); ?>
    </h1>

    <p style="margin:0 0 16px;">
        <?php echo esc_html($translate('rtb_approved.intro')); ?>
    </p>
    ...
    <div style="padding:16px; border:2px solid #16a34a; border-radius:8px; margin-bottom:24px; background:#f0fdf4;">
        <p style="margin:0; font-size:16px; font-weight:600; color:#15803d;">
            ✓ <?php echo esc_html($translate('rtb_approved.status_approved')); ?>
        </p>
    </div>
    ...
    <p style="margin:0; font-size:14px; color:#556987;">
        <?php echo esc_html($translate('rtb_approved.footer_note')); ?>
    </p>
</div>
