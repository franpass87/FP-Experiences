...
* Admin: disattivato il ::before Dashicon di WordPress sulle checkbox FP così non si sovrappone alla spunta custom.

= 1.6.54 - 2026-04-05 =

* Admin: checkbox sotto shell FP resi con stile custom (SVG unico) per eliminare ghosting residuo su Chromium/Windows.
...
* Admin Dettagli: blocco «Categorie, tag e attributi» con empty state e link ai termini quando non ci sono voci da selezionare.

= 1.6.50 - 2026-04-05 =

* Admin Dettagli: «Badge di fiducia» come griglia card 3 colonne (stile caratteristiche predefinite), etichetta visibile + h4 screen reader; dark mode.

= 1.6.49 - 2026-04-05 =

* Admin Dettagli: «Badge personalizzati» sotto «Caratteristiche predefinite» a tutta larghezza (fix wrapper griglia tassonomie).

= 1.6.48 - 2026-04-05 =

* Admin Dettagli: griglia «Caratteristiche predefinite» a card 3 colonne con icona su tile viola; titolo sezione intermedio solo per screen reader; dark mode.

= 1.6.47 - 2026-04-05 =

* Admin: allineamento design system FP (CSS admin, metabox Calendario/Policy/Pricing, pagine impostazioni/strumenti/email/ecc.); rebuild JS; aggiornamenti shortcode/pricing/voucher; doc `MODULAR-ARCHITECTURE.md` e tool diagnostici in `tools/`.

= 1.6.46 - 2026-04-05 =

* Importer: fix errore fatale PHP per `use function wp_kses_post` duplicato in `ImporterPage.php`.

= 1.6.45 - 2026-04-05 =

* Importer CSV: taxonomie temi/lingue, biglietto default da prezzo base, badge family-friendly, ricorrenza sanificata, meta calendario e generazione slot DB.

= 1.6.44 - 2026-04-05 =

* Admin: fix larghezza card «Slot orario» nel tab Calendario (repeater a tutta riga dentro `.fp-exp-field` flex).

= 1.6.43 - 2026-04-05 =

* Admin: sezione Dettagli «Contenuto, categorie e fiducia» allineata al design system FP (card DMS, griglie, dark); fix i18n etichette tassonomie (niente doppio escape).

= 1.6.42 - 2026-04-05 =

* Admin: reset box-shadow su checkbox/radio sotto shell FP; focus DMS su campi con whitelist tipi; card Richieste speciali senza alone.

= 1.6.41 - 2026-04-05 =

* Admin: fix focus `.fp-exp-dms-field` che applicava l’anello a tutte le checkbox; card «Richieste speciali» con selettori più stretti.

= 1.6.40 - 2026-04-05 =

* Admin: fix focus/hover sulle card checkbox «Richieste speciali» (niente doppio outline, accent DMS).

= 1.6.39 - 2026-04-05 =

* Admin Dettagli: sezione Widget — Richieste speciali riprogettata (blocchi DMS, griglia campi, alert info, card checkbox preset).

= 1.6.38 - 2026-04-05 =

* Admin metabox: token DMS su media/calendario; FAQ repeater `item-body`; select meeting point + bottoni tab allineati al DS.

= 1.6.37 - 2026-04-05 =

* Admin: metabox Impostazioni esperienza e Ordine di visualizzazione con guscio FP (gradiente header, tab pill, alert sync WPML); bundle CSS aggiornato.
* Repo: aggiunti in Git i CSS admin importati da main.css (prima assenti dal tree) per build ripetibile.

= 1.6.36 - 2026-04-05 =

* Admin: query string CSS/JS (`fp-exp-admin`) include il filemtime del file oltre alla versione plugin, così rebuild dei bundle non resta bloccata da cache 304 del browser.

= 1.6.35 - 2026-04-05 =

* Admin: liste dati (Dashboard, Log, Richieste RTB, Check-in) con contenitore `.fp-exp-table-shell`; Log con card toolbar filtri + diagnostica in card DMS; Check-in senza stili inline su scanner/operatori mobile.

= 1.6.34 - 2026-04-05 =
* **Changed**: Admin — allineamento estetico al design system FP (banner senza ombra, token DMS su layout, metabox, impostazioni, calendario, tab).

= 1.6.33 - 2026-04-05 =
* **Fixed**: Metabox Calendario — «Aggiungi slot orario» funziona di nuovo (repeaters admin allineati al markup).

= 1.6.32 - 2026-04-05 =
* **Added**: Metabox Prezzi — immagine opzionale per ogni addon/extra (mostrata nel widget se impostata).
* **Fixed**: Widget/shortcode — label addon da campo `name` quando manca `label`.

= 1.6.31 - 2026-04-03 =
* **Fixed**: Barra CTA mobile — non si sovrappone al footer in fondo pagina (spazio automatico).

= 1.6.30 - 2026-04-03 =
* **Changed**: Icone titolo sezioni pagina esperienza — SVG inline al posto del font FA (centratura corretta nel box).

= 1.6.29 - 2026-04-03 =
* **Fixed**: Icone sezione — centratura glifo FA nel `::before` (absolute + translate).

= 1.6.28 - 2026-04-03 =
* **Fixed**: Icone sezioni pagina esperienza — centrate nel riquadro blu (Font Awesome nel box).

= 1.6.27 - 2026-04-03 =
* **Fixed**: «Informazioni utili» non più in cima al main per mancanza di `order` nel CSS flex (ora tra galleria e regalo).
...
= 1.6.16 - 2026-04-03 =
* **Added**: Badge custom — select icona da elenco con anteprima; più icone Font Awesome disponibili.

= 1.6.15 - 2026-04-03 =
* **Changed**: Icone badge predefinite — Font Awesome 6 (stesso set sul sito); caricamento FA in modifica esperienza admin.

= 1.6.14 - 2026-04-03 =
* **Added**: Meta Dettagli — badge predefiniti (checkbox + icone) e badge personalizzati con «Aggiungi badge» (icona, titolo, descrizione).
* **Changed**: Admin JS — editor badge custom; bundle minificato incluso nel repo.
* **Fixed**: Shortcode — icone badge custom da meta.

= 1.6.13 - 2026-04-03 =
* **Changed**: Sezione overview — caratteristiche esperienza/evento come card con icona e tipografia più chiara (titolo vs descrizione).

= 1.6.12 - 2026-04-03 =
* **Fixed**: Box regalo in pagina esperienza — resta visibile con vendite chiuse (solo acquisto disabilitato e messaggio in hero/modale).
* **Added**: Stili hero regalo (`.fp-exp-gift__*`) e modale informativa (`.fp-gift__intro--blocked`).

= 1.6.11 - 2026-04-03 =
* **Changed**: Modale regalo — icona decorativa accanto al titolo.
