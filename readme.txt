...
= 1.6.36 - 2026-04-05 =
* **Added**: Liste CPT Esperienze e Meeting point — margini coerenti con gift voucher (`cpt-list-shell.css` nel bundle admin).
* **Changed**: `admin.css` importa i moduli gift voucher e CPT list; documentazione inventario admin (`ADMIN-SCREENS.md`).

= 1.6.35 - 2026-04-05 =
* **Fixed**: Calendario in Operazioni — `initCalendarApp` incluso nel JS admin minificato (`calendar-admin-app.js`); stili toolbar/griglia completati in `calendar.css`.

= 1.6.34 - 2026-04-05 =
* **Fixed**: Pagina Operazioni e tab — CSS incluso nel bundle admin minificato (`calendar-operations.css`), non solo nel monolite `admin.css`.

= 1.6.33 - 2026-04-05 =
* **Changed**: Lista Gift voucher — stili nel bundle admin condiviso (`gift-voucher-list.css`); `admin.css` e min con token `--fpdms-*` per ombra/raggio/transizione.

= 1.6.32 - 2026-04-05 =
* **Fixed**: Ripristino lista Gift voucher e CSS admin allo stato precedente al layout custom (come versione stabile pre–1.6.29).

= 1.6.31 - 2026-04-05 =
* **Changed**: CSS lista gift voucher solo su quella schermata; bundle admin allineato alle altre pagine FP.

= 1.6.30 - 2026-04-05 =
* **Fixed**: Admin — variabili CSS `:root` con prefisso `fpdms` per evitare conflitti con core/editor.

= 1.6.29 - 2026-04-05 =
* **Changed**: Admin lista Gift voucher — banner gradiente FP, card elenco, badge colore sulla colonna stato.

= 1.6.27 - 2026-04-04 =
* **Fixed**: Script `sync-source-to-dist-build.ps1` — fine file pulita (nessuna riga duplicata/corrotta).
