...
final class RtbHoldExpiryCron implements HookableInterface
{
    ...
    public function process(): void
    {
        ...
        if ($request_to_book instanceof RequestToBook) {
            $past_n = $request_to_book->process_rtb_past_slot_auto_declines(150);

            if ($past_n > 0) {
                Logger::log('cron', sprintf('RTB past-slot auto-decline: %d reservation(s) declined', $past_n));
            }
        }
    }
}
