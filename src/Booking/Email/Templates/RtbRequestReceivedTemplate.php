...
/**
 * Template for RTB request received email to customer.
 */
final class RtbRequestReceivedTemplate extends AbstractEmailTemplate
{
    /**
    ...
    {
        return FP_EXP_PLUGIN_DIR . 'templates/emails/rtb-request-received.php';
    }
    ...
    protected function getDefaultSubject(array $context): string
    {
        ...
        if (EmailTranslator::LANGUAGE_IT === $language) {
            return sprintf(
                ...
                __('Richiesta ricevuta per %s', 'fp-experiences'),
        ...
        return sprintf(
            /* translators: %s: experience title. */
            __('Request received for %s', 'fp-experiences'),
            esc_html($experience_title)
        );
    }
