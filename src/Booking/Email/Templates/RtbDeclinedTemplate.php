...
/**
 * Template for RTB declined email to customer.
 */
final class RtbDeclinedTemplate extends AbstractEmailTemplate
{
    /**
    ...
    {
        return FP_EXP_PLUGIN_DIR . 'templates/emails/rtb-declined.php';
    }
    ...
    protected function getDefaultSubject(array $context): string
    {
        ...
        if (EmailTranslator::LANGUAGE_IT === $language) {
            return sprintf(
                ...
                __('Aggiornamento sulla tua richiesta per %s', 'fp-experiences'),
        ...
        return sprintf(
            /* translators: %s: experience title. */
            __('Update on your request for %s', 'fp-experiences'),
            esc_html($experience_title)
        );
    }
