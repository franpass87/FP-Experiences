...
/**
 * Template for booking reminder email to customer.
 */
final class BookingReminderTemplate extends AbstractEmailTemplate
{
    /**
    ...
    {
        return FP_EXP_PLUGIN_DIR . 'templates/emails/customer-reminder.php';
    }
    ...
    /**
     * Get email attachments (reminder includes attachments).
     *
     * @param array<string, mixed> $context
     *
     * @return array<string>
