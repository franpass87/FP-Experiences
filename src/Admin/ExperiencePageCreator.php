...
final class ExperiencePageCreator implements HookableInterface
{
    ...
    public function render_page(): void
    {
        ...
        echo '<h2 class="fpexp-page-header-title" aria-hidden="true">' . esc_html__('Crea pagina esperienza', 'fp-experiences') . '</h2>';
        echo '<p class="fpexp-page-header-desc">' . esc_html__('Genera una pagina WordPress con shortcode preconfigurato per un\'esperienza.', 'fp-experiences') . '</p>';
        echo '</div>';
