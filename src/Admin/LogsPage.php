...
final class LogsPage implements HookableInterface
{
    ...
    public function render_page(): void
    {
        ...
        echo '<h2 class="fpexp-page-header-title" aria-hidden="true">' . esc_html__('FP Experiences Logs', 'fp-experiences') . '</h2>';
        echo '<p class="fpexp-page-header-desc">' . esc_html__('Monitora gli eventi applicativi, esporta diagnosi e ripulisci i registri di sistema.', 'fp-experiences') . '</p>';
        echo '</div>';
