...
final class ToolsPage implements HookableInterface
{
    ...
    public function render_page(): void
    {
        ...
        echo '<h2 class="fpexp-page-header-title" aria-hidden="true">' . esc_html__('Strumenti operativi', 'fp-experiences') . '</h2>';
        echo '<p class="fpexp-page-header-desc">' . esc_html__('Esegui azioni di manutenzione: sincronizzazioni Brevo, ripubblicazione eventi, pulizia cache e diagnostica.', 'fp-experiences') . '</p>';
        echo '</div>';
