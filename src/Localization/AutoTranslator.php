...
final class AutoTranslator implements HookableInterface
{
    ...
    private const STRINGS = [
        ...
        'Potrai verificare il totale e completare il pagamento al checkout. Il destinatario riceverà il voucher la mattina programmata o immediatamente dopo il pagamento se non è stata selezionata una data. La data dell\'evento verrà scelta dal destinatario in fase di riscatto del voucher.' => 'You can review the total and complete payment at checkout. The recipient will receive the voucher on the scheduled morning or immediately after payment if no date was selected. The event date will be chosen by the recipient when redeeming the voucher.',
